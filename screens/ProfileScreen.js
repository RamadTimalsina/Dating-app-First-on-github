...
const ProfileScreen = () => {
  ...
  const getUserDetails = async () => {
    try {
      ...
      const response = await axios.get(`http://10.0.2.2:2000/users/${userId}`);
    ...
    <SafeAreaView style={{flex: 1, backgroundColor: 'white'}}>
      <View
        ...
        <View>
          <Image
            ...
            source={{
              uri: 'https://t3.ftcdn.net/jpg/01/30/70/98/360_F_130709887_zbKQK98gH8LGPzRp4ArSbmQYARMshyoX.jpg',
            }}
          />
        </View>
      ...
      <View style={{marginTop: 30, marginHorizontal: 20}}>
        <Image
          ...
          source={{
            uri:'https://wallpaperboat.com/wp-content/uploads/2020/06/09/44637/couple-22.jpg'
          }}
        />
      </View>
      ...
      <View
        ...
        <View>
          <Text style={{fontSize: 15, fontWeight: '600',color:"black",}}>Boost</Text>
      ...
      <View
        ...
        <View>
          <Text style={{fontSize: 15, fontWeight: '600',color:"black"}}>Roses</Text>
          <Text style={{color: 'gray', marginTop: 3}}>
