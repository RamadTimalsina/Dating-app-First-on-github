...
import {
  ...
  const LoginScreen = () => {
    ...
    const signInUser = async() => {
      setOption('Sign In');
        ...
        try {
          ...
          const response = await axios.post('http://10.0.2.2:2000/login', user);
          console.log('Dfdfd');
    ...
    const handleLogin = () => {
      ...
      axios.post('http://10.0.2.2:2000/login', user).then(response => {
      ...
      <SafeAreaView
        ...
        <KeyboardAvoidingView>
          ...
          <View
            ...
            <Image
              style={{ width: 200, height: 90, resizeMode: 'cover', marginTop: 14 }}
              source={{
